...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2016 a las 02:16:42
...
(2, '2 x 1', '1', 'Pague lleve 2', '', 0, '2016-06-10', '2016-06-17', '2016-06-10 11:12:07', '2016-06-10 11:12:07');
...
(1, 0, 0, 0, 0, 0, '2016-06-03 10:00:00', '0000-00-00 00:00:00', 3, 2, 2);
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `imageProduct1` text COLLATE utf8_unicode_ci NOT NULL,
  `imageProduct2` text COLLATE utf8_unicode_ci,
  `imageProduct3` text COLLATE utf8_unicode_ci,
  `imageProduct4` text COLLATE utf8_unicode_ci,
  `imageProduct5` text COLLATE utf8_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `products` (`id`, `name_product`, `material`, `price`, `description_product`, `imageProduct1`, `imageProduct2`, `imageProduct3`, `imageProduct4`, `imageProduct5`, `created_at`, `updated_at`, `category_id`, `offer_id`, `state_id`) VALUES
(2, '', 'Madera', 10, 'mesa armable y desarmable para un facil desplazamineto', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1, 5),
(3, '', 'Lamina', 20, 'Armario, dos puertas, espejos en las puertas, coloro vino tinto', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 2, 1, 5),
(4, '', 'Madera', 30, 'Mesa para televisor de 60" color madera y armable con gabinete.', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 3, 1, 5),
(5, '', 'madera', 40, 'Peinadora para niñas, color rosa, espejo y un gabinete.', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 4, 1, 5),
(7, '', 'Madera', 50, 'Nochero de decoracion para la habitacion', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '2016-06-10 11:23:22', '2016-06-10 11:23:22', 5, 1, 5),
(12, '', 'Prueba', 122, 'Mesa para computador de mesa', 'no-product-image.jpg', NULL, NULL, NULL, NULL, '2016-06-17 21:07:41', '2016-06-17 21:07:41', 1, 1, 5);
...
(3, 'Pendiente', 'Pedidos', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'Recibido', 'Pedidos', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Disponible', 'Productos\r\n', '2016-06-17 05:00:00', '2016-06-17 05:00:00'),
(6, 'Productos', 'Agotado', '2016-06-17 05:00:00', '2016-06-17 05:00:00');
...
(1, 1, 'Farid', 'Ospina', 8847696, 300216676, 'Buenos aires', 'jfospina00@misena.edu.co', '$2y$10$A2aLy5KyJ7A.QixWRNp35OEPRVXVUNLxsRYYGko7YQ85fvsN7nKna', 'qFVuX4DWYYRJJ3nYsl25wAW9x9FQWlsizquJFZVuRCgsnT9mdkf1kDB1aTmU', '2016-05-18 14:56:21', '2016-06-18 00:14:17'),
(2, 2, 'Johny Farid', 'Ospina', 8847698, 2147483647, 'Buenos Aires', 'farid.ospina@gmail.com', '$2y$10$EXByHUEbbAXUCTE/LWOoKO8yLwAgYqZlNJYqM5kvc0ocJS48VKFo.', 'Dbcd65a9UVVkQqszMl9fIwUKQ2ZPqQJioxSDtBmEv2A2n0MxVfZvXly7XpXj', '2016-05-27 09:07:22', '2016-06-15 23:53:42'),
(3, 1, 'Andres', '', 0, 0, '', 'piperios@misena.edu.co', '$2y$10$.ChlXJQ51HuOWgf2rRqu8eMHo3aqj8hc7eITz8jyp8RQOD3oOIx/O', '7NXI9OFEI6IrNWtioaG8YloNBa93RDoIs5rzRbJ9NC6iEkdl9Rw3V8lbHkJA', '2016-05-27 11:01:02', '2016-05-27 11:01:53');
