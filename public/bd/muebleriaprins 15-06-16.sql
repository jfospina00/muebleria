...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2016 a las 21:03:20
...
INSERT INTO `products` (`id`, `name_product`, `material`, `price`, `description_product`, `created_at`, `updated_at`, `category_id`, `offer_id`,`state_id`) VALUES
(2, '', 'Madera', 10, 'mesa armable y desarmable para un facil desplazamineto', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1, 2),
(3, '', 'Lamina', 20, 'Armario, dos puertas, espejos en las puertas, coloro vino tinto', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 2, 1, 2),
(4, '', 'Madera', 30, 'Mesa para televisor de 60" color madera y armable con gabinete.', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 3, 1, 2),
(5, '', 'madera', 40, 'Peinadora para niñas, color rosa, espejo y un gabinete.', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 4, 1, 2),
(7, '', 'Madera', 50, 'Nochero de decoracion para la habitacion', '2016-06-10 06:23:22', '2016-06-10 06:23:22', 5, 1, 1);
...
(1, 1, 'Farid', 'Ospina', 8847696, 300216676, 'Buenos aires', 'jfospina00@misena.edu.co', '$2y$10$A2aLy5KyJ7A.QixWRNp35OEPRVXVUNLxsRYYGko7YQ85fvsN7nKna', 'zK5ERT36OuLldloQXAsniIxJzHZ6ALL71Z1u018cNPLpJncDZSzGOv4QuIdn', '2016-05-18 09:56:21', '2016-06-15 18:02:52'),
(2, 2, 'Johny Farid', 'Ospina', 8847698, 2147483647, 'Buenos Aires', 'farid.ospina@gmail.com', '$2y$10$EXByHUEbbAXUCTE/LWOoKO8yLwAgYqZlNJYqM5kvc0ocJS48VKFo.', 'Dbcd65a9UVVkQqszMl9fIwUKQ2ZPqQJioxSDtBmEv2A2n0MxVfZvXly7XpXj', '2016-05-27 04:07:22', '2016-06-15 18:53:42'),
